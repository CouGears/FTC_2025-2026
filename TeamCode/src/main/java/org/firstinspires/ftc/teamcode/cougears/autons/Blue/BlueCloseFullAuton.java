...
public class BlueCloseFullAuton extends OpMode {
    ...
    public void stepUpdate() {
        ...
        switch (currStep) {
            case SHOOT_BALLS:
                if (bot.handleShootingSequence(shootPos, follower, telemetry, false, false)) { // Any step after a step which moves the bot must have this if statement to make sure we dont do anything until the bot is in teh right spot
                    if (BDCounter == 2){
